...
const Walls = () => {
    ...
    useEffect(() => {
        ...
        if (left_sidebar && left_sidebar.current) left_sidebar.current.style.left = window.outerWidth / window.innerHeight > 16 / 10 ? `${((window.innerWidth - (window.innerHeight * 16 / 10)) / 2) - left_sidebar.current.clientWidth}px` : "-200px";
        if (right_sidebar && right_sidebar.current) right_sidebar.current.style.right = window.outerWidth / window.innerHeight > 16 / 10 ? `${((window.innerWidth - (window.innerHeight * 16 / 10)) / 2) - right_sidebar.current.clientWidth}px` : "-200px";
